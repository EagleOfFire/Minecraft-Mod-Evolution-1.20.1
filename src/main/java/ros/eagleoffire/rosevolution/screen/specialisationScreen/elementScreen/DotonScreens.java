...
public class DotonScreens {
    ...
    public static class DotonRangSScreen extends Screen {
        ...
        protected void init() {
            ...
            for (int i = 0; i < spellTexts.size() && i < spellCommands.size(); i++) {
                if (spellRanks.get(i).equals("S") && spellCategories.get(i).equals("Doton")) {
    ...
    public static class DotonRangAScreen extends Screen {
        ...
        protected void init() {
            ...
            int a = 0;
            for (int i = 0; i < spellTexts.size() && i < spellCommands.size(); i++) {
                if (spellRanks.get(i).equals("A") && spellCategories.get(i).equals("Doton")) {
                    String textureName = spellTextures.get(i);
                    DynamicTexture cachedTexture = ModClientConfigs.getButtonImages().get(textureName);
    ...
    public static class DotonRangBScreen extends Screen {
        ...
        protected void init() {
            ...
            int a = 0;
            for (int i = 0; i < spellTexts.size() && i < spellCommands.size(); i++) {
                if (spellRanks.get(i).equals("B") && spellCategories.get(i).equals("Doton")) {
                    String textureName = spellTextures.get(i);
                    DynamicTexture cachedTexture = ModClientConfigs.getButtonImages().get(textureName);
    ...
    public static class DotonRangCScreen extends Screen {
        ...
        protected void init() {
            ...
            int a = 0;
            for (int i = 0; i < spellTexts.size() && i < spellCommands.size(); i++) {
                if (spellRanks.get(i).equals("C") && spellCategories.get(i).equals("Doton")) {
                    String textureName = spellTextures.get(i);
                    DynamicTexture cachedTexture = ModClientConfigs.getButtonImages().get(textureName);
