...
public class FutonScreens {
    ...
    public static class FutonRangSScreen extends Screen {
        ...
        protected void init() {
            ...
            FutonScreens.init(this.width, this.height, this.minecraft);
            ...
            for (int i = 0; i < spellTexts.size() && i < spellCommands.size(); i++) {
                if (spellRanks.get(i).equals("S") && spellCategories.get(i).equals("Futon")) {
    ...
    public static class FutonRangAScreen extends Screen {
        ...
        protected void init() {
            ...
            int a = 0;
            for (int i = 0; i < spellTexts.size() && i < spellCommands.size(); i++) {
                if (spellRanks.get(i).equals("A") && spellCategories.get(i).equals("Futon")) {
                    String textureName = spellTextures.get(i);
                    DynamicTexture cachedTexture = ModClientConfigs.getButtonImages().get(textureName);
    ...
    public static class FutonRangBScreen extends Screen {
        ...
        protected void init() {
            ...
            int a = 0;
            for (int i = 0; i < spellTexts.size() && i < spellCommands.size(); i++) {
                if (spellRanks.get(i).equals("B") && spellCategories.get(i).equals("Futon")) {
                    String textureName = spellTextures.get(i);
                    DynamicTexture cachedTexture = ModClientConfigs.getButtonImages().get(textureName);
    ...
    public static class FutonRangCScreen extends Screen {
        ...
        protected void init() {
            ...
            int a = 0;
            for (int i = 0; i < spellTexts.size() && i < spellCommands.size(); i++) {
                if (spellRanks.get(i).equals("C") && spellCategories.get(i).equals("Futon")) {
                    String textureName = spellTextures.get(i);
                    DynamicTexture cachedTexture = ModClientConfigs.getButtonImages().get(textureName);
